...
const defaultItems: ProgressItem[] = [
  ...
  { label: "Profile Photo", percentage: 100, completed: true },
  { label: "About Section", percentage: 100, completed: true },
  { label: "Services", percentage: 100, completed: true },
  { label: "Portfolio", percentage: 80, completed: false },
  { label: "Reviews", percentage: 80, completed: false },
];
