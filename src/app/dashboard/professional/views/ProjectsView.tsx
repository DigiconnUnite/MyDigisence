...
const defaultProjects: Project[] = [
  { id: "1", title: "E-Commerce Platform", description: "Full-featured online store with payment integration", image: "/project-1.jpg", technologies: ["Next.js", "Node.js", "MongoDB", "Stripe"], status: "completed", views: 2341, likes: 156, createdAt: "2024-01" },
  { id: "2", title: "Task Management App", description: "Collaborative project management tool", image: "/project-2.jpg", technologies: ["React", "TypeScript", "Node.js", "PostgreSQL"], status: "in-progress", views: 1890, likes: 98, createdAt: "2024-03" },
  { id: "3", title: "Real Estate Website", description: "Property listing and search platform", image: "/project-3.jpg", technologies: ["Next.js", "Tailwind CSS", "Prisma"], status: "completed", views: 3422, likes: 234, createdAt: "2023-11" },
  { id: "4", title: "Social Media Dashboard", description: "Analytics dashboard for social media", image: "/project-4.jpg", technologies: ["Vue.js", "D3.js", "Firebase"], status: "in-progress", views: 1234, likes: 67, createdAt: "2024-04" },
  { id: "5", title: "AI Content Generator", description: "AI-powered content creation tool", image: "/project-5.jpg", technologies: ["Python", "OpenAI", "FastAPI", "React"], status: "planned", views: 0, likes: 0, createdAt: "2024-05" },
];
...
export default function ProjectsView({
  ...
  const stats = {
    ...
    totalViews: data.reduce((acc, p) => acc + p.views, 0),
  };
          ...
          <div className="divide-y">
            {filteredProjects.map((project) => (
              <div key={project.id} className="flex items-center gap-4 p-4 hover:bg-gray-50 transition-colors">
                <div className="h-16 w-16 bg-gradient-to-br from-slate-200 to-slate-300 rounded-lg flex items-center justify-center shrink-0">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex flex-wrap gap-1 mt-1">
                    {project.technologies.map((tech, i) => (
                      <span key={i} className="text-xs text-gray-400">{tech}{i < project.technologies.length - 1 ? " • " : ""}</span>
                    ))}
                  </div>
                </div>
